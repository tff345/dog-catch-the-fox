    ...
    def construct(self):
        ...
        # show question
          ...
          fmlto6c_2 = MathTex(
             ...
             font_size=40
        ).move_to(fmlto6c_1.get_center())
          self.play(
             ClockwiseTransform(fmlto6c_1,fmlto6c_2)
        )    
          fmlto6c_3 = MathTex(
               r"v_2^2 t_1 + v_2 q-v_2L = v_1^2t_1-v_1q\cos \theta",
               font_size=40
               ).move_to(fmlto6c_2.get_center())
          self.play(ReplacementTransform(fmlto6c_1, fmlto6c_3))
          fmlto6c_4 = MathTex(
          ...
          fml6c = MathTex(
            r"t_1",r"=-\frac{v_1 \cos \theta +v_2}{v_2^2-v_1^2}",
            font_size=40
          ).move_to(fmlto6c_4.get_center())
